...
*/}}
{{- define "${{values.component_id}}.fullname" -}}
...
*/}}
{{- define "${{values.component_id}}.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "${{values.component_id}}.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
